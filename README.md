...
class Life {
    constructor() {
        this.problemImportance;
        this.choiceDifficulty;
        this.lifeMode;
    }

    handleProblemImportance() {
        if (this.problemImportance < Importance.HIGH) {
            this.relax();
        }
    }

    handleChoiceDifficulty() {
        if (this.choiceDifficulty === Difficulty.HARD) {
            this.setLifeMode(Mode.EASY);
        }
    }
    ...
    relax() {
        <img src="https://emojis.slackmojis.com/emojis/images/1577305505/7373/hand_wave.gif?1577305505" width="50" height ="50/>
    }
}
